...
ALTER TABLE `crm_projects_equipment` ADD `price` TEXT NOT NULL;
...
ALTER TABLE  `experts_docs`  ADD FOREIGN KEY (  `file_id` ) REFERENCES  `e-head_ec`.`files` (`id`)  ON DELETE SET NULL ON UPDATE RESTRICT ;
