...
--- ?? нужно спросить, делать SET NULL или оставить CASCADE ---
ALTER TABLE  `messages` DROP FOREIGN KEY  `messages_ibfk_2` ;
ALTER TABLE  `messages` ADD CONSTRAINT  `messages_ibfk_2` FOREIGN KEY (  `receiver_id` ) REFERENCES  `e-head_ec`.`accounts` (
`id`
) ON DELETE SET NULL ON UPDATE RESTRICT ;


ALTER TABLE  `messages` ADD FOREIGN KEY (  `owner_id` ) REFERENCES  `e-head_ec`.`accounts` (
`id`
