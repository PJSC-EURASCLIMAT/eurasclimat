...
3.0 as published by the Free Software Foundation and appearing in the file LICENSE 
    ...
    init: function(parent) {
        ...
        if (parent.displayInfo) {
            ...
            this.progressBar.on('render', function(pb) {
                pb.mon(pb.getEl().applyStyles('cursor:pointer'), 'click', 
        ...
        updateInfo : function() {
            if (this.displayItem) {
                var count = this.store.getCount(),
                    ...
                    message = count === 0 ? this.emptyMsg : Ext.String.format(
                        this.displayMsg, pageData.fromRecord, 
                        pageData.toRecord, this.store.getTotalCount()
                    ),
                    percentage = pageData.pageCount > 0 
                        ? (pageData.currentPage / pageData.pageCount) : 0;
