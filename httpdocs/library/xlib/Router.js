/*!
 * xlib.Router
 * http://github.com/brunotavares/xlib.Router
 *
...
Ext.define('xlib.Router', {
    ...
    routeMatcher: function(app, route, rules) {
        ...
        if (!routeObj.controller && Ext.isDefined(Ext.global.console)) {
            Ext.global.console.error("[xlib.Router] Config 'controller' can't be undefined", route, rules);
        }
    
        if (!routeObj.action && Ext.isDefined(Ext.global.console)) {
            Ext.global.console.error("[xlib.Router] Config 'action' can't be undefined", route, rules);
        }
        //</debug>
    ...
    dispatch: function(token, route, params) {
        ...
        if (!controller[route.action] && Ext.isDefined(Ext.global.console)) {
            Ext.global.console.error("[xlib.Router] Controller action not found ", route.controller, route.action);
            return false;
        }
        //</debug>
        ...
        if (!classMgr.get(controllerFullName)) {
            ...
            if (!classMgr.get(controllerFullName)) {
                ...
                if (Ext.isDefined(Ext.global.console)) {
                    Ext.global.console.warn("[xlib.Router] Controller not found ", route.controller);
                }
                //</debug>
