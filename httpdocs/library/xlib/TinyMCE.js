    ...
    Ext.define('xlib.TinyMCE', {
        ...
        */
        initComponent: function() {
            ...
            xlib.TinyMCE.initTinyMCE({ language: this.tinymceSettings.language });
        },
        ...
        initValue: function() {
            ...
            if (!this.rendered)
                ...
                if (this.value !== undefined) {
                    ...
                    throw "xlib.TinyMCE.initValue: No initial value available";
            ...
            */
            initTinyMCE: function(settings) {
                if (!tmceInitialized) {
                    ...
                    WindowManager
                    */
                    WindowManager = Ext.define('tinymce.WindowManager', {
                    ...
                    ControlManager
                    */
                    ControlManager = Ext.define('tinymce.ControlManager', {
    
                        // Reference to ExtJS control xlib.TinyMCE.
                        control: null,
                    ...
                    var s = {
                        mode: "none",
                        plugins: xlib.TinyMCE.tinymcePlugins,
                        theme: "advanced"
                    };
