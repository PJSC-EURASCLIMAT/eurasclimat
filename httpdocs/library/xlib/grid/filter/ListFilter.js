 ...
 *
 */
Ext.define('xlib.grid.filter.ListFilter', {
    extend: 'xlib.grid.filter.Filter',
...
filter : [{"type":"list","value":"small,medium","field":"size"}]
    ...
    createMenu: function(config) {
        var menu = Ext.create('xlib.grid.menu.ListMenu', config);
