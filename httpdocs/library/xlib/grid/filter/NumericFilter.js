 ...
 * </code></pre>
 * <p>Any of the configuration options for {@link xlib.grid.menu.RangeMenu} can also be specified as
 * configurations to NumericFilter, and will be copied over to the internal menu instance automatically.</p>
 */
Ext.define('xlib.grid.filter.NumericFilter', {
    ...
    createMenu: function(config) {
        var me = this,
            menu;
        menu = Ext.create('xlib.grid.menu.RangeMenu', config);
