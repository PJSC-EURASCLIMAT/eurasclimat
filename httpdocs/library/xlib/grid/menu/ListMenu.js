/**
 * @class xlib.grid.menu.ListMenu
 * @extends Ext.menu.Menu
 * This is a supporting class for {@link xlib.grid.filter.ListFilter}.
 * Although not listed as configuration options for this class, this class
 * also accepts all configuration options from {@link xlib.grid.filter.ListFilter}.
 */
Ext.define('xlib.grid.menu.ListMenu', {
