/**
 * @class xlib.grid.menu.RangeMenu
 ...
 * by {@link xlib.grid.filter.NumericFilter} to create its menu.
 */
Ext.define('xlib.grid.menu.RangeMenu', {
...
fields : {
    gt: { // override fieldCfg options
        width: 200,
        fieldCls: xlib.form.CustomNumberField // to override default {@link #fieldCls}
    }
},
     * </code></pre>
     */
...
menuItemCfgs : {
    ...
    constructor : function (config) {
        ...
        me.addEvents(
             ...
             * @param {xlib.grid.filter.Filter} this The filter object.
             */
            'update'
        );
