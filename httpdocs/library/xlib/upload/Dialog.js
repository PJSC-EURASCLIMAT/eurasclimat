 ...
 * 
 *      @example
 *      var dialog = Ext.create('xlib.upload.Dialog', {
 ...
 * 
 */
Ext.define('xlib.upload.Dialog', {
    extend : 'Ext.window.Window',

    requires : [
        'xlib.upload.ItemGridPanel',
        'xlib.upload.Manager',
        'xlib.upload.StatusBar',
        'xlib.upload.BrowseButton',
        'xlib.upload.Queue'
    ],
    ...
    config : {
         ...
         * uploader object, for example if the {@link xlib.upload.uploader.ExtJsUploader} is used, the params are sent
         * as GET params.
         */
        uploadParams : {},
        ...
        selectionMessageText : 'Выбрано {0} файл(а/ов), {1}',
    ...
    /**
     * @property {xlib.upload.Queue}
     */
    queue : null,

    /**
     * @property {xlib.upload.ItemGridPanel}
     */
    grid : null,

    /**
     * @property {xlib.upload.Manager}
     */
    uploadManager : null,

    /**
     * @property {xlib.upload.StatusBar}
     */
    statusBar : null,

    /**
     * @property {xlib.upload.BrowseButton}
     */
    browseButton : null,
    ...
    initComponent : function() {
        ...
        this.addEvents({
             ...
             * 
             * @param {xlib.upload.Dialog} dialog
             * @param {xlib.upload.Manager} manager
             * @param {xlib.upload.Item[]} items
        ...
        this.grid = Ext.create('xlib.upload.ItemGridPanel', {
            queue : this.queue,
        ...
        this.uploadManager = Ext.create('xlib.upload.Manager', {
            url : this.uploadUrl,
        ...
        this.statusBar = Ext.create('xlib.upload.StatusBar', {
            dock : 'bottom',
    ...
    getTopToolbarConfig : function() {
        ...
        this.browseButton = Ext.create('xlib.upload.BrowseButton', {
            id : 'button_browse',
     ...
     * 
     * @return {xlib.upload.Queue}
     */
    initQueue : function() {
        var queue = Ext.create('xlib.upload.Queue');
     ...
     * new files.
     * 
     * @param {xlib.upload.BrowseButton} input
