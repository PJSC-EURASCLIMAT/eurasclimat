Ext.define('EC.CRM.controller.Calcfot.Main', {
    ...
    stores: [
        'EC.CRM.store.Calcfot.Main'
    ],
    
    models: [
        'EC.CRM.model.Calcfot.Main'
    ],
    
    views: [
        'EC.CRM.view.Calcfot.MainList',
        'EC.CRM.view.Calcfot.MainEdit'
    ],
    
    addURL: '/json/crm/calcfot/add',
    
    updateURL: '/json/crm/calcfot/update',
    
    deleteURL: '/json/crm/calcfot/delete',
    
    permission: acl.isUpdate('calcfot'),
    
    run: function(container) {

        this.Container = container; 
        
        var grid = container.add(Ext.create('EC.CRM.view.Calcfot.MainList', {permission: this.permission}));
    ...
    addItem: function() {
        ...
        var module = this.getView('EC.CRM.view.Calcfot.MainEdit').create(),
