Ext.define('EC.CRM.controller.Demoprojects.Configurator', {
    
    extend: 'Ext.app.Controller',
    
    stores: [
        'EC.CRM.store.Demoprojects.Configurator.Equipment',
        'EC.CRM.store.Demoprojects.Configurator.SpecialServices'
    ],
    
    models: [
        'EC.CRM.model.Demoprojects.Configurator.Equipment',
        'EC.CRM.model.Demoprojects.Configurator.SpecialServices'
    ],
    
    views: [
        'EC.CRM.view.Demoprojects.Configurator.EquipmentList',
        'EC.CRM.view.Demoprojects.Configurator.SpecialServicesList'
    ],
    ...
    addEquipmentURL: '/json/crm/demoprojects-configurator/add-equipment',
    
    deleteEquipmentURL: '/json/crm/demoprojects-configurator/delete-equipment',
    
    addSpecialServiceURL: '/json/crm/demoprojects-configurator/add-special-service',
    
    deleteSpecialServiceURL: '/json/crm/demoprojects-configurator/delete-special-service',
    ...
    run: function(container) {
        ...
        this.Container = Ext.create('EC.CRM.view.Demoprojects.Configurator.Layout', {
    ...
    editEquipment: function(grid, record) {
        var editWin = this.getController('EC.CRM.controller.Demoprojects.Configurator.EquipmentEditor');
    ...
    editSpecialService: function(grid, record) {
        var editWin = this.getController('EC.CRM.controller.Demoprojects.Configurator.SpecialServicesEditor');
        editWin.itemID = record.get('id');
