Ext.define('EC.CRM.controller.Projects.Configurator.SpecialServicesEditor', {
    
    extend: 'Ext.app.Controller',
    
    permissions: acl.isUpdate('projects'),
    
    getURL: '/json/crm/projects-configurator/get-special-service',
    
    setURL: '/json/crm/projects-configurator/update-special-service',
    
    addExpendableURL: '/json/crm/projects-configurator/add-expendable',
    
    updateExpendableURL: '/json/crm/projects-configurator/update-expendable',
    
    deleteExpendableURL: '/json/crm/projects-configurator/delete-expendable',
    
    views: [
        'EC.CRM.view.Projects.Configurator.SpecialServiceForm',
    ...
    run: function() {
        ...
        this.ssForm = this.getView('EC.CRM.view.Projects.Configurator.SpecialServiceForm').create();
        this.eGrid = this.getView('EC.CRM.view.Projects.Configurator.ExpendablesList').create();
