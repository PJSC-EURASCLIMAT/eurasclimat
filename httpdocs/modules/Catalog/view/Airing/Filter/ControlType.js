Ext.define('EC.Catalog.view.Airing.Filter.ControlType', {
    
    extend: 'Ext.form.ComboBox',
    
    alias: ['widget.AiringFilterControlType'],
    ...
    store: { 
        ...
        storeId: ['AiringFilterControlType'],
        ...
        proxy: {
            ...
            extraParams: {entity: 'airing_control_types'},
            reader: {
                type: 'json',
                root: 'data',
