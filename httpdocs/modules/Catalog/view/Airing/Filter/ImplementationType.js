Ext.define('EC.Catalog.view.Airing.Filter.ImplementationType', {
    
    extend: 'Ext.form.ComboBox',
    
    alias: ['widget.AiringFilterImplementationType'],
    ...
    store: { 
        ...
        storeId: ['AiringFilterImplementationType'],
        ...
        proxy: {
            ...
            extraParams: {entity: 'airing_implementation_types'},
            reader: {
                type: 'json',
                root: 'data',
