Ext.define('EC.Catalog.view.Automation.Filter.ImplementationType', {
    
    extend: 'Ext.form.ComboBox',
    
    alias: ['widget.AutomationFilterImplementationType'],
    ...
    store: { 
        ...
        storeId: ['AutomationFilterImplementationType'],
        ...
        proxy: {
            ...
            extraParams: {entity: 'automation_implementation_types'},
            reader: {
                type: 'json',
                root: 'data',
