Ext.define('EC.Catalog.view.Dustextraction.Filter.Mark', {
    
    extend: 'Ext.form.ComboBox',
    
    alias: ['widget.DustextractionFilterMark'],
    ...
    store: { 
        ...
        storeId: 'DustextractionFilterMark',
        ...
        proxy: {
            ...
            extraParams: {entity: 'dustextraction_marks'},
            reader: {
                type: 'json',
                root: 'data',
