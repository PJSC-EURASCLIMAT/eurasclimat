Ext.define('EC.Catalog.view.Electricity.Filter.ProtectionType', {
    
    extend: 'Ext.form.ComboBox',
    
    alias: ['widget.ElectricityFilterProtectionType'],
    ...
    store: { 
        ...
        storeId: ['ElectricityFilterProtectionType'],
        ...
        proxy: {
            ...
            extraParams: {entity: 'electricity_protection_types'},
            reader: {
                type: 'json',
                root: 'data',
