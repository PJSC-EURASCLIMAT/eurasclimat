Ext.define('EC.Catalog.view.Heating.Filter.ConnectionType', {
    
    extend: 'Ext.form.ComboBox',
    
    alias: ['widget.HeatingFilterConnectionType'],
    ...
    store: { 
        ...
        storeId: ['HeatingFilterConnectionType'],
        ...
        proxy: {
            ...
            extraParams: {entity: 'heating_connection_types'},
            reader: {
                type: 'json',
                root: 'data',
