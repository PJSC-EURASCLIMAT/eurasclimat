Ext.define('EC.Catalog.view.Heating.Filter.PowerSource', {
    
    extend: 'Ext.form.ComboBox',
    
    alias: ['widget.HeatingFilterPowerSource'],
    ...
    store: { 
        ...
        storeId: 'HeatingFilterPowerSource',
        ...
        proxy: {
            ...
            extraParams: {entity: 'heating_power_sources'},
            reader: {
                type: 'json',
                root: 'data',
