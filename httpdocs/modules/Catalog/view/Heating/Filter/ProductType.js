Ext.define('EC.Catalog.view.Heating.Filter.ProductType', {
    
    extend: 'Ext.form.ComboBox',
    
    alias: ['widget.HeatingFilterProductType'],
    ...
    store: { 
        ...
        storeId: ['HeatingFilterProductType'],
        ...
        proxy: {
            ...
            extraParams: {entity: 'heating_product_types'},
            reader: {
                type: 'json',
                root: 'data',
