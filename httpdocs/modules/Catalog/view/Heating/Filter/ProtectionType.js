Ext.define('EC.Catalog.view.Heating.Filter.ProtectionType', {
    
    extend: 'Ext.form.ComboBox',
    
    alias: ['widget.HeatingFilterProtectionType'],
    ...
    store: { 
        ...
        storeId: ['HeatingFilterProtectionType'],
        ...
        proxy: {
            ...
            extraParams: {entity: 'heating_protection_types'},
            reader: {
                type: 'json',
                root: 'data',
