Ext.define('EC.Catalog.view.Watersupply.Filter.ProductType', {
    
    extend: 'Ext.form.ComboBox',
    
    alias: ['widget.WatersupplyFilterProductType'],
    ...
    store: { 
        ...
        storeId: ['WatersupplyFilterProductType'],
        ...
        proxy: {
            ...
            extraParams: {entity: 'watersupply_product_types'},
            reader: {
                type: 'json',
                root: 'data',
