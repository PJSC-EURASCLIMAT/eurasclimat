Ext.define('EC.Catalog.view.Watersupply.Filter.ProtectionType', {
    
    extend: 'Ext.form.ComboBox',
    
    alias: ['widget.WatersupplyFilterProtectionType'],
    ...
    store: { 
        ...
        storeId: ['WatersupplyFilterProtectionType'],
        ...
        proxy: {
            ...
            extraParams: {entity: 'watersupply_protection_types'},
            reader: {
                type: 'json',
                root: 'data',
