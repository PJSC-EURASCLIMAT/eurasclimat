Ext.define('EC.Contractors.controller.Docs', {

    itemId: 'EC.Contractors.controller.Docs',
    
    extend: 'Ext.app.Controller',

    addDocURL: '/json/crm/contractors-docs/add-doc',
    uploadURL: '/json/crm/contractors-docs/upload',
    deleteDocURL: '/json/crm/contractors-docs/delete',
    downloadURL: '/json/crm/contractors-docs/download',
    updateDocURL: '/json/crm/contractors-docs/update-doc',

    uploadDocVersionURL: '/json/crm/contractors-docs-versions/upload-version',
    deleteDocVersionURL: '/json/crm/contractors-docs-versions/delete-version',
    downloadDocVersionURL: '/json/crm/contractors-docs-versions/download-version',

    refs: [
        { ref: 'docList', selector: 'contractors-docs-list' }
    ],

    stores: [
        'xlib.DocTypes.store.DocTypes',
        'EC.Contractors.store.Docs',
        'EC.Contractors.store.DocsVersions'
    ],

    models: [
        'xlib.DocTypes.model.DocTypes',
        'EC.Contractors.model.Docs',
        'EC.Contractors.model.DocsVersions'
    ],

    views: [
        'xlib.DocTypes.view.Combo',
        'EC.Contractors.view.Docs.List',
        'EC.Contractors.view.Docs.Versions'
    ],

    cur_item_id: null,

    run: function(container, cur_item_id) {
        
        this.Container = container;
        this.cur_item_id = cur_item_id;
        
        container.add(this.getView('EC.Contractors.view.Docs.List'));
    ...
    openVersionsForDoc: function(record) {
        ...
        this.docVerList = Ext.create('EC.Contractors.view.Docs.Versions').show();
    ...
    editDoc: function(record) {
        ...
        var view = Ext.create('EC.Contractors.view.Docs.Edit', {
            docModel: record
        });
    ...
    addDoc: function() {
        ...
        var view = Ext.create('EC.Contractors.view.Docs.Add', {
            item_id: this.cur_item_id
        });
