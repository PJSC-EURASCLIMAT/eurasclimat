          ...
          switch (activeTabName) {
            ...
            case 'stages':
              if (!this.projectStages.loaded) {
                this.gridProjectStages.getStore().load({params:{project_id: record.get('id')}});
                this.projectStages.loaded = true;
              }
            break;
            case 'docs':
              if (!this.projectDocs.loaded) {
                this.gridProjectDocs.getStore().load({params:{project_id: record.get('id')}});
                this.projectDocs.loaded = true;
              }
            break;
            case 'projectComments':
              if (!this.projectComments.loaded) {
                this.projectCommentsStore.load({params:{project_id: record.get('id')}});
                this.projectVotesStore.load({params:{project_id: record.get('id')}});
