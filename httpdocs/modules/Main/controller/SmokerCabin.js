Ext.define('EC.Main.controller.SmokerCabin', {
    
    extend: 'Ext.app.Controller',
    
    stores: [
        'EC.Main.store.SmokerCabin.ThemesTree'
    ],
    
    models: [
        'EC.Main.model.SmokerCabin.ThemesTree'
    ],

    views: [
        'EC.Main.view.SmokerCabin.Layout',
        'EC.Main.view.SmokerCabin.ThemesTree'
    ],
    ...
    run: function(container) {
        ...
        var content = container.add({
            xtype: 'SmokerCabinLayout'
        });
        
        var treePanel = content.down('SmokerCabinThemesTree'),
            treeStore = this.getStore('EC.Main.store.SmokerCabin.ThemesTree'),
...
//                });
                ...
                var win = Ext.create('Ext.window.Window', {
                    ...
                    buttons: [{
                        ...
                        handler: function() {
                            Ext.Ajax.request({
                                url: '/json/smokercabin/description/update-description-content',
                                params: {
