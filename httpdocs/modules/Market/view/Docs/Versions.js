Ext.define('EC.Market.view.Docs.Versions', {

    itemId: 'EC.Market.view.Docs.Versions',
    
    extend: 'Ext.window.Window',
    
    alias: 'widget.market-docs-versions-win',
    ...
    items: [{
        ...
        itemId: 'docVersGrid',
        border: false,
        store: 'EC.Market.store.DocsVersions',
        listeners: {
