Ext.define('EC.Market.view.Trade.List', {
    ...
    store: {
        ...
        data : [
            ...
            {id: 9, name: '«Лидер-инвест»', url: 'http://www.uk.sistema.ru/pages/main/customs/index.shtml'},
            ...
            {id: 16, name: 'Гос Услуги', url: 'https://esia.gosuslugi.ru/idp/Authn/CommonLogin'},
            ...
            {id: 21, name: 'РЖД (сайт)', url: 'http://www.rzd.ru'},
            {id: 22, name: 'Заказ РФ', url: 'http://zakazrf.ru'},
            {id: 23, name: 'B2B-Center', url: 'http://www.b2b-center.ru/personal/'}   
        ]
    },
