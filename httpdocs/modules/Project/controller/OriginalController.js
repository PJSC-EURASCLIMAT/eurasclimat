Ext.define('EC.Project.controller.OriginalController', {
    ...
    initProjectComponents: function(content) {
        ...
        this.gridProjectStage = this.getView('EC.Project.view.StageList').create();
        this.projectStage.add(this.gridProjectStage);
          
        this.projectDoc = this.detailTab.down('#docs');
        this.gridProjectDoc = this.getView('EC.Project.view.DocList').create();
        ...
        this.projectCommentStore = Ext.create('EC.Project.store.Comment');
        ...
        this.projectVoteStore = Ext.create('EC.Project.store.Vote');
