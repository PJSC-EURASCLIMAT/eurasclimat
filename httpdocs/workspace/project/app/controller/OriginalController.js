Ext.define('Project.controller.OriginalController', {
    ...
    initProjectComponents: function(content) {
        ...
        this.gridProjectStage = this.getView('Project.view.StageList').create();
        this.projectStage.add(this.gridProjectStage);
          
        this.projectDoc = this.detailTab.down('#docs');
        this.gridProjectDoc = this.getView('Project.view.DocList').create();
        ...
        this.projectCommentStore = Ext.create('Project.store.Comment');
        ...
        this.projectVoteStore = Ext.create('Project.store.Vote');
