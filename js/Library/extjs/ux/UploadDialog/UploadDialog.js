...
Ext.extend(Ext.ux.UploadDialog.Dialog, Ext.Panel, {
    ...
    createProgressBar: function(){
        ...
        this.getTopToolbar().add(this.progress_bar);
...
p.i18n = {
    ...
    add_btn_tip: 'Добавить файл в очередь передачи.',
    remove_btn_text: 'Удалить',
    remove_btn_tip: 'Удалить файл из очереди передачи.',
    reset_btn_text: 'Сброс',
    reset_btn_tip: 'Очистить очередь.',
    upload_btn_start_text: 'Передать',
    upload_btn_stop_text: 'Остановить',
    upload_btn_start_tip: 'Передать очередь файлов на сервер.',
    upload_btn_stop_tip: 'Остановить передачу.',
    close_btn_text: 'Закрыть',
    close_btn_tip: 'Закрыть диалог.',
    progress_waiting_text: 'Ждите...',
    progress_uploading_text: 'Передача: {0} из {1} файл(ов) завершена.',
    error_msgbox_title: 'Ошибка',
    permitted_extensions_join_str: ',',
    err_file_type_not_permitted: 'Выбранный файл с таким расширением не допускается.<br/>Пожалуйста, выбирайте файлы только со следующими расширениями: {1}',
    note_queued_to_upload: 'Очередь для передачи.',
    note_processing: 'Передача...',
    note_upload_failed: 'Сервер недоступен или произошла внутренняя ошибка на сервере.',
    note_upload_success: 'OK',
    note_upload_error: 'Ошибка передачи.',
