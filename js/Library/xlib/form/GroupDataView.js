...
xlib.form.GroupDataView = Ext.extend(Ext.DataView, {
    
    initComponent: function() {
        
        xlib.form.GroupDataView.superclass.initComponent.call(this);
		this.state = {};
        if (!this.startGroup) {
    ...
    afterRender: function() {
        xlib.form.GroupDataView.superclass.afterRender.call(this);
