...
class Catalog_ElectricityWiresController extends Catalog_AbstractController
{
    public function init()
    {
        $this->_entity = 'electricity.wires';
        $this->_model = new Catalog_Electricity_Wires_Model();
        parent::init();
    }
