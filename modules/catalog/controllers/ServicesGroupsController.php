...
class Catalog_ServicesGroupsController extends Xend_Controller_Action
{
    ...
    {
        $this->_model = new Catalog_Services_Groups();
        parent::init();
    }

    public function permission(Xend_Controller_Action_Helper_Acl $acl)
    {
        $acl->setResource(Xend_Acl_Resource_Generator::getInstance()->catalog->services);
