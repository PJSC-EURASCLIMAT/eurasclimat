...
class Catalog_Heating_Model
{
    ...
    public function getInfo($id)
    {
        ...
        $select = $this->_table->getAdapter()->select()
            ...
            ->joinLeft(
                array('product_types' => 'catalog_heating_product_types'),
            ...
            ->joinLeft(
                array('implementation_types' => 'catalog_heating_implementation_types'),
            ...
            ->joinLeft(
                array('control_types' => 'catalog_heating_control_types'),
            ...
            ->joinLeft(
                array('connection_types' => 'catalog_heating_connection_types'),
            ...
            ->joinLeft(
                array('protection_types' => 'catalog_heating_protection_types'),
            ...
            ->joinLeft(
                array('power_sources' => 'catalog_heating_power_sources'),
            ...
            ->joinLeft(
                array('materials' => 'catalog_heating_materials'),
    ...
    public function update(array $params)
    {
        $f = new Xend_Filter_Input(array(
            ...
            'productivity'          => array(array('StringLength', 0, 255), 'allowEmpty' => true),
            'burner_power'          => array(array('StringLength', 0, 255), 'allowEmpty' => true),
            ...
            'back_pressure'         => array(array('StringLength', 0, 255), 'allowEmpty' => true),
            ...
            'burner_tube_length'    => array(array('StringLength', 0, 255), 'allowEmpty' => true),
            'burner_tube_hole'      => array(array('StringLength', 0, 255), 'allowEmpty' => true),
            'chimney_diameter'      => array(array('StringLength', 0, 255), 'allowEmpty' => true),
            'efficiency'            => array(array('StringLength', 0, 255), 'allowEmpty' => true),
