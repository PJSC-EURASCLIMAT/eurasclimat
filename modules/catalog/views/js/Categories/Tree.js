Ext.ns('Catalog.Categories');

Catalog.Categories.Tree = Ext.extend(xlib.TreePanel, {

    title: 'Категории',

    loadURL: link('catalog', 'categories', 'get'),
    
    addURL: link('catalog', 'categories', 'add'),
    
    updateURL: link('catalog', 'categories', 'update'),
    
    deleteURL: link('catalog', 'categories', 'delete'),
    ...
    initComponent: function() {
        ...
        Catalog.Categories.Tree.superclass.initComponent.apply(this, arguments);
    },
...
Ext.reg('Catalog.Categories.Tree', Catalog.Categories.Tree);