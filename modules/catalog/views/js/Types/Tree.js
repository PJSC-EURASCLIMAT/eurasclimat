...
Catalog.Types.Tree = Ext.extend(xlib.TreePanel, {

    title: 'Типы',

    loadURL: link('catalog', 'types', 'get'),
    
    addURL: link('catalog', 'types', 'add'),
    
    updateURL: link('catalog', 'types', 'update'),
    
    deleteURL: link('catalog', 'types', 'delete'),
    ...
    initComponent: function() {
        ...
        Catalog.Types.Tree.superclass.initComponent.apply(this, arguments);
    },
...
Ext.reg('Catalog.Types.Tree', Catalog.Types.Tree);