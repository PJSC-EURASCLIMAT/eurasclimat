...
class Crm_CalcsmrProjectController extends Xend_Controller_Action
{
    protected $_model;

    public function init()
    {
        $this->_model = new Crm_Calcsmr_Projects();
        parent::init();
    }
    ...
    {
        $response = $this->_model->getList($this->_getParam('project_id'));
