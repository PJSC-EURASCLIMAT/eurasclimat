 ...
 */
class Crm_DemoprojectsDiscussionsController extends Xend_Controller_Action
{

    public function init()
    {
        $this->_model = new Crm_Demoprojects_Discussions_Model();
        parent::init();
    }

    public function permission(Xend_Controller_Action_Helper_Acl $acl)
    {
        $acl->setResource(Xend_Acl_Resource_Generator::getInstance()->crm->demoprojects->discussions);
