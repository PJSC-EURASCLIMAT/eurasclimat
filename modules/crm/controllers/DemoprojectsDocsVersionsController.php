 ...
 */
class Crm_DemoprojectsDocsVersionsController extends Xend_Controller_Action
{
    ...
    {
        $acl->setResource(Xend_Acl_Resource_Generator::getInstance()->crm->demoprojects->docs->versions);
