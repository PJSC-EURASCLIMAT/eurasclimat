...
class Crm_Demoprojects_Configurator_Model
{
    protected $_table,
        $_equipmentTable,
        $_servicesTable,
    ...
    public function __construct()
    {
        ...
        $this->_equipmentTable = new Crm_Demoprojects_Configurator_EquipmentTable();
        $this->_servicesTable = new Crm_Demoprojects_Configurator_ServicesTable();
        $this->_specialServicesTable = new Crm_Demoprojects_Configurator_SpecialServicesTable();
        $this->_expendablesTable = new Crm_Demoprojects_Configurator_ExpendablesTable();
    }
    ...
    public function addEquipment(array $params)
    {
        ...
        $tableName = 'Catalog_' . ucfirst($f->entity) . '_Table';
        try {
            $table = new $tableName;
        } catch (Exception $e) {
            if (DEBUG) {
