 ...
 */
class Smokercabin_DescriptionController extends Xend_Controller_Action
{

    public function init()
    {
        $this->_model = new Smokercabin_Description_Model();
        parent::init();
    }

    public function permission(Xend_Controller_Action_Helper_Acl $acl)
    {
        $acl->setResource(Xend_Acl_Resource_Generator::getInstance()->smokercabin);
